...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        roomData: List<RoomDatum>.from(json["room_data"].map((x) => RoomDatum.fromJson(x))),
    );
...
class RoomDatum {
    ...
    factory RoomDatum.fromJson(Map<String, dynamic> json) => RoomDatum(
        ...
        gallery: List<Gallery>.from(json["gallery"].map((x) => galleryValues.map[x]!)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "gallery": List<dynamic>.from(gallery.map((x) => galleryValues.reverse[x])),
...
final ruleValues = EnumValues({
    "receptionist": Rule.RECEPTIONIST
});
...
class SearchDataClass {
    ...
    factory SearchDataClass.fromJson(Map<String, dynamic> json) => SearchDataClass(
